...
// replace tests object end
content = content.replace(/    writing_test1: \[\s*\{[\s\S]*?    \]\n\};\n?/g, newWriting_1 + "\n\n");

// replace if conditions
const targetIfs = `            } else if (currentTestId === \x27writing_test1\x27) {
                document.getElementById(\x27test-title\x27).textContent = \x27Writing Task 2 (1. Vãn hóa - Ð? 1)\x27;
            } else if (currentTestId === \x27writing_test2\x27) {
                document.getElementById(\x27test-title\x27).textContent = \x27Writing Task 2 (2. Vãn hóa - Ð? 2)\x27;
            } else if (currentTestId === \x27writing_test3\x27) {
                document.getElementById(\x27test-title\x27).textContent = \x27Writing Task 2 (3. Giáo d?c - Ð? 1)\x27;
            } else if (currentTestId === \x27writing_test4\x27) {
                document.getElementById(\x27test-title\x27).textContent = \x27Writing Task 2 (4. Giáo d?c - Ð? 2)\x27;
            } else if (currentTestId === \x27writing_test5\x27) {
                document.getElementById(\x27test-title\x27).textContent = \x27Writing Task 2 (5. Công ngh? - Ð? 1)\x27;
            } else if (currentTestId === \x27writing_test6\x27) {
                document.getElementById(\x27test-title\x27).textContent = \x27Writing Task 2 (6. Công ngh? - Ð? 2)\x27;
            } else if (currentTestId === \x27writing_test7\x27) {
                document.getElementById(\x27test-title\x27).textContent = \x27Writing Task 2 (7. Môi trý?ng - Ð? 1)\x27;
            } else if (currentTestId === \x27writing_test8\x27) {
                document.getElementById(\x27test-title\x27).textContent = \x27Writing Task 2 (8. Môi trý?ng - Ð? 2)\x27;
            }`;
...
content = content.replace(targetIfs, newIfs);
